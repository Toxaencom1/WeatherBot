...
ALTER TABLE weather_response_data
    ADD CONSTRAINT FK56xqxf20otnt82twnchiamwqo FOREIGN KEY (hourly_weather_id) REFERENCES hourly_weather (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-23
ALTER TABLE current_weather
    ADD CONSTRAINT FK7esr9vn2efdtojqpcno3o50o1 FOREIGN KEY (wind_id) REFERENCES wind (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-24
ALTER TABLE current_weather
    ADD CONSTRAINT FK82889ra11cv6fonhx1c6v955o FOREIGN KEY (precipitation_id) REFERENCES precipitation (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-25
ALTER TABLE hourly_data
    ADD CONSTRAINT FKau2jeq7e730872dprd3at00m8 FOREIGN KEY (precipitation_id) REFERENCES precipitation (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-26
ALTER TABLE hourly_data
    ADD CONSTRAINT FKbjq24odn8bhjxk1ufxhcdo77d FOREIGN KEY (wind_id) REFERENCES wind (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-27
ALTER TABLE hourly_data
    ADD CONSTRAINT FKer2jrqjh7shimtc60v2at3tnp FOREIGN KEY (cloud_cover_id) REFERENCES cloud_cover (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-28
ALTER TABLE hourly_weather_data
    ADD CONSTRAINT FKhwe3ogb36m1di0eijw7s7cua FOREIGN KEY (hourly_weather_id) REFERENCES hourly_weather (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-29
ALTER TABLE location
    ADD CONSTRAINT FKn5m6ve3ryy2r25qvisdrg0aos FOREIGN KEY (country_id) REFERENCES country (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-30
ALTER TABLE location
    ADD CONSTRAINT FKr2gdhhu8rhyrvslukhtfbg8v5 FOREIGN KEY (city_id) REFERENCES city (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-31
ALTER TABLE city
    ADD CONSTRAINT FKrpd7j1p7yxr784adkx4pyepba FOREIGN KEY (country_id) REFERENCES country (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-32
ALTER TABLE hourly_weather_data
    ADD CONSTRAINT FKstf5rjdcjwxdaiiwihakg8nbo FOREIGN KEY (data_id) REFERENCES hourly_data (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-33
ALTER TABLE weather_response_data
    ADD CONSTRAINT FKtathb3yqm08ppj52vcghipdhp FOREIGN KEY (current_weather_id) REFERENCES current_weather (id) ON UPDATE RESTRICT ON DELETE RESTRICT;

-- changeset TaXaH:1734789970892-34
ALTER TABLE subscriber
    ADD CONSTRAINT FKtqnh75ik28dj63b1et4ws9lqb FOREIGN KEY (location_id) REFERENCES location (id) ON UPDATE RESTRICT ON DELETE RESTRICT;
